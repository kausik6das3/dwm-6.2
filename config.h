...
static const char col_cyan[]        = "#288a72";
...
static Key keys[] = {
	...
	{ MODKEY, 			XK_bracketright,  spawn,          SHCMD("pactl set-sink-volume 0 +5%") },
	{ MODKEY, 			XK_bracketleft,   spawn,          SHCMD("pactl set-sink-volume 0 -5%") },
